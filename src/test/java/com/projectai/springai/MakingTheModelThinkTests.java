...
public class MakingTheModelThinkTests extends BaseTestClass {
	    ...
	    void testSteps() {
			...
			System.out.println(openAiChatModel.call(promptTemplate.create()).getResult().getOutput().getContent());
	    ...
	    void testIncorrectPrompt() {
	        ...
	        System.out.println(openAiChatModel.call(promptTemplate.create(
	        		Map.of("studentSolution", studentSolution)
